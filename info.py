...
# FORCE_SUB 
auth_req_channel = environ.get('AUTH_REQ_CHANNEL', '-1002827860401')  # requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://rohankumarjena22022007:Ux5LA9E17V8BU7cK@cluster0.ozk8fns.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
# Movie Notification & Update Settings
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', True))  # Notification On (True) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002891372329'))  # Notification of sent to your channel
