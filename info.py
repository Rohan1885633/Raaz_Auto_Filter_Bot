...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002490458338').split()]  # Channel id for auto indexing (make sure bot is admin)
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002876184332')  # Support group id (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/mrX6XYWh/photo-2025-07-25-18-39-58-7531091172031201296.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'jenarohankumar@okicici')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Rohankumar188:uSqdfdMYg3d3nIX3@cluster0.l59u52s.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://Rohankumar188:uSqdfdMYg3d3nIX3@cluster0.l59u52s.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/RJ_BOTS_2024")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/RJ_BOTS_2024")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/RJ_BOTS_2024")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/rjbots2025') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/rjbots2025') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/The_Movies_Officially') # Update channel link for the bot
